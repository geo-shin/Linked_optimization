        ...
        for g in range(self.generation):
            ...
            for idx, p in enumerate(self.pop):
                ...
                if st_selected == 0:  # Normal version
                    ...
                    p, p.best, best = HgsCFPSO.updateParticle(self,p, best, p2_1, p2_2, iw, verbose=verbose)
                elif st_selected == 4: # BBPSO
                    p, p.best, best = HgsBBPSO.updateParticle(self,p, best, p1_1, p1_2, iw, verbose=verbose)
                else: # CLPSO
                    Pc = HgsCLPSO.calculate_pc(self,Niter)
                    p, p.best, best = HgsCLPSO.updateParticle(self,p, best, p1_1, p1_2,Niter,Pc, iw, verbose=verbose)
